<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LinkStudentToCourseAndInstructor.aspx.cs" Inherits="WebApplication1.LinkStudentToCourseAndInstructor" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <h1>Link Student To</h1>
            <h1>Course And Instructor</h1>
            course ID: <br>
            ...
            semester code: <br>
            <asp:TextBox ID="semesterCode" runat="server"></asp:TextBox> <br>
