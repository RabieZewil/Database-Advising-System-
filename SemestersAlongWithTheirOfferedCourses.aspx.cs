...
{
    public partial class SemestersAlongWithTheirOfferedCourses : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand logicFunc = new SqlCommand("SELECT * FROM Semster_offered_Courses", conn);           // is using select * allowed here ?
