...
{
    public partial class ViewAllGraduationPlans : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand logicFunc = new SqlCommand("SELECT * FROM Advisors_Graduation_Plan", conn);           // is using select * allowed here ?
