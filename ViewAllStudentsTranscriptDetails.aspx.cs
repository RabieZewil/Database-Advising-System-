...
{
    public partial class ViewAllStudentsTranscriptDetails : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand logicFunc = new SqlCommand("SELECT * FROM Students_Courses_transcript", conn);           // is using select * allowed here ?
