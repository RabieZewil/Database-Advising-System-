...
{
    public partial class approve_reject_extra__credi__hours : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    conn.Open();
                    SqlCommand cmd = new SqlCommand("Procedures_AdvisorApproveRejectCHRequest", conn);
                    cmd.CommandType = CommandType.StoredProcedure;

                    cmd.Parameters.AddWithValue("current_sem_code", sem_code);
