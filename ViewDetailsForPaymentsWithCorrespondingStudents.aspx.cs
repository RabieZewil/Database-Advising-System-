...
{
    public partial class ViewDetailsForPaymentsWithCorrespondingStudents : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand logicFunc = new SqlCommand("SELECT * FROM Student_Payment", conn);           // is using select * allowed here ?
